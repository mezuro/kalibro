...
public class ResultsAggregator {
	...
	public ResultsAggregator(ProjectResult projectResult, Map<Module, ModuleResult> resultMap) {
		this(projectResult.getDate(), projectResult.getSourceTree(), resultMap);
	}
